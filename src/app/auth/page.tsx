...
export default async function Page() {
   ...
   return (
      <main className="w-screen h-[100dvh] px-4 sm:px-6 grid place-items-center bg-secondary dark:bg-background">
         <div className="max-w-[380px] w-full p-6 text-center bg-background border dark:border-border/30 dark:bg-secondary rounded-lg">
